...
/*
  ...
  у зоніПочтаку можна створити внутрішні змінні для цього циклу

  у зоніУмови треба писати умову продовження циклу

  у зоніКроку треба вказувати дію або дії, які треба зробити після кожної ітерації
*/
